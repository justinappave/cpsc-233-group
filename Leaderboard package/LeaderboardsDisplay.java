...
public class LeaderboardsDisplay implements ActionListener {
	...
	public LeaderboardsDisplay(int moveOrTime) {
		//Label properties
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("back")) {
            ...
            //driver.LeaderboardMenu();
			frame.dispose();
		}
		else if(e.getActionCommand().equals("reset")) {
            HighScores hs = new HighScores();
            hs.resetFiles();
            LeaderboardsDisplay ld = new LeaderboardsDisplay(1);
			frame.dispose();
		}
	}
}