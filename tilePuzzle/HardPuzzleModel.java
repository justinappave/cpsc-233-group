...
public class HardPuzzleModel {
    private static final int ROWS = 5;
    private static final int COLS = 5;
    
    private Tile4[][] _contents;  // All tiles.
    private Tile4     _emptyTile; // The empty space.
    
    
    //================================================= constructor
    public HardPuzzleModel() {
        _contents = new Tile4[ROWS][COLS];
    ...
    public void reset() {
        for (int r=0; r<ROWS; r++) {
            for (int c=0; c<COLS; c++) {
                _contents[r][c] = new Tile4(r, c, "" + (r*COLS+c+1));
            }
        }
...
class Tile4 {
    ...
    //==================================================== constructor
    public Tile4(int row, int col, String face) {
        _row = row;
        _col = col;
        _face = face;
    }//end constructor
