...
public class MediumPuzzleModel {
    private static final int ROWS = 4;
    private static final int COLS = 4;
    
    private Tile3[][] _contents;  // All tiles.
    private Tile3     _emptyTile; // The empty space.
    
    
    //================================================= constructor
    public MediumPuzzleModel() {
        _contents = new Tile3[ROWS][COLS];
    ...
    public void reset() {
        for (int r=0; r<ROWS; r++) {
            for (int c=0; c<COLS; c++) {
                _contents[r][c] = new Tile3(r, c, "" + (r*COLS+c+1));
            }
        }
...
class Tile3 {
    ...
    //==================================================== constructor
    public Tile3(int row, int col, String face) {
        _row = row;
        _col = col;
        _face = face;
    }//end constructor
