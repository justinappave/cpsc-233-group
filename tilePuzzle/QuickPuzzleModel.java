...
public class QuickPuzzleModel {
    private static final int ROWS = 3;
    private static final int COLS = 3;
    
    private Tile2[][] _contents;  // All tiles.
    private Tile2     _emptyTile; // The empty space.
    
    
    //================================================= constructor
    public QuickPuzzleModel() {
        _contents = new Tile2[ROWS][COLS];
    ...
    public void reset() {
        for (int r=0; r<ROWS; r++) {
            for (int c=0; c<COLS; c++) {
                _contents[r][c] = new Tile2(r, c, "" + (r*COLS+c+1));
            }
        }
