...
public class LargePuzzleLogic {
    private static final int ROWS = 5;
    private static final int COLS = 5;
    
    private LargeTile[][] _contents;  // All tiles.
    private LargeTile     _emptyTile; // The empty space.
    
    
    //================================================= constructor
    public LargePuzzleLogic() {
        _contents = new LargeTile[ROWS][COLS];
    ...
    public void reset() {
        for (int r=0; r<ROWS; r++) {
            for (int c=0; c<COLS; c++) {
                _contents[r][c] = new LargeTile(r, c, "" + (r*COLS+c+1));
            }
        }
    ...
    private void exchangeTiles(int r1, int c1, int r2, int c2) {
        LargeTile temp = _contents[r1][c1];
...
class LargeTile {
    ...
    //==================================================== constructor
    public LargeTile(int row, int col, String face) {
        _row = row;
        _col = col;
        _face = face;
    }//end constructor
