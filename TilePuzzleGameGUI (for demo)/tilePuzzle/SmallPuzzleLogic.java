...
public class SmallPuzzleLogic {
    private static final int ROWS = 3;
    private static final int COLS = 3;
    
    private SmallTile[][] _contents;  // All tiles.
    private SmallTile     _emptyTile; // The empty space.
    
    
    //================================================= constructor
    public SmallPuzzleLogic() {
        _contents = new SmallTile[ROWS][COLS];
    ...
    public void reset() {
        for (int r=0; r<ROWS; r++) {
            for (int c=0; c<COLS; c++) {
                _contents[r][c] = new SmallTile(r, c, "" + (r*COLS+c+1));
            }
        }
    ...
    private void exchangeTiles(int r1, int c1, int r2, int c2) {
        SmallTile temp = _contents[r1][c1];
...
class SmallTile {
    ...
    //==================================================== constructor
    public SmallTile(int row, int col, String face) {
        _row = row;
        _col = col;
        _face = face;
    }//end constructor
