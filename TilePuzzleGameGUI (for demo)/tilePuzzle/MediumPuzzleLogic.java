...
public class MediumPuzzleLogic {
    private static final int ROWS = 4;
    private static final int COLS = 4;
    
    private MediumTile[][] _contents;  // All tiles.
    private MediumTile     _emptyTile; // The empty space.
    
    
    //================================================= constructor
    public MediumPuzzleLogic() {
        _contents = new MediumTile[ROWS][COLS];
    ...
    public void reset() {
        for (int r=0; r<ROWS; r++) {
            for (int c=0; c<COLS; c++) {
                _contents[r][c] = new MediumTile(r, c, "" + (r*COLS+c+1));
            }
        }
    ...
    private void exchangeTiles(int r1, int c1, int r2, int c2) {
        MediumTile temp = _contents[r1][c1];
...
class MediumTile {
    ...
    //==================================================== constructor
    public MediumTile(int row, int col, String face) {
        _row = row;
        _col = col;
        _face = face;
    }//end constructor
